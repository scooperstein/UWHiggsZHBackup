#ifndef JetMETCorrections_METPUSubtraction_PFMEtSignInterfaceBase_h
#define JetMETCorrections_METPUSubtraction_PFMEtSignInterfaceBase_h
 ...
 *
 * $Id: PFMEtSignInterfaceBase.h,v 1.4 2013/01/26 11:42:16 veelken Exp $
 *
 */

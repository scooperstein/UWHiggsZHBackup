...
void BKG_UP_OFpA::initProc(string param_card_name) 
{
...
void BKG_UP_OFpA::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ccx_emepmummupa_no_hzpxg(); 
        ...
        t[1] = matrix_ccx_emepmummupa_no_hzpxg(); 
        double tsum = 0; 
...
void BKG_UP_OFpA::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//   int i, j; 
  ...
  FFV1_2(w[0], w[6], pars->Unitary_GC_6, pars->MC, pars->ZERO, w[49]); 
  FFV1_3(w[49], w[1], pars->Unitary_GC_6, pars->ZERO, pars->ZERO, w[50]); 
  FFV2_5_3(w[49], w[1], pars->Unitary_GC_71, pars->Unitary_GC_74, pars->MZ, pars->WZ, w[51]); 
  FFV1_2(w[49], w[8], pars->Unitary_GC_6, pars->MC, pars->ZERO, w[52]); 
  FFV1_2(w[49], w[28], pars->Unitary_GC_6, pars->MC, pars->ZERO, w[53]); 
  FFV2_5_2(w[49], w[31], pars->Unitary_GC_71, pars->Unitary_GC_74, pars->MC, pars->ZERO,
      w[54]);
  FFV2_5_2(w[49], w[13], pars->Unitary_GC_71, pars->Unitary_GC_74, pars->MC, pars->ZERO,
      w[55]);
  FFV1_1(w[1], w[6], pars->Unitary_GC_6, pars->MC, pars->ZERO, w[56]); 
  FFV1_3(w[0], w[56], pars->Unitary_GC_6, pars->ZERO, pars->ZERO, w[57]); 
  FFV2_5_3(w[0], w[56], pars->Unitary_GC_71, pars->Unitary_GC_74, pars->MZ, pars->WZ, w[58]); 
  FFV1_2(w[0], w[8], pars->Unitary_GC_6, pars->MC, pars->ZERO, w[59]); 
  FFV1_2(w[0], w[28], pars->Unitary_GC_6, pars->MC, pars->ZERO, w[60]); 
  FFV2_5_2(w[0], w[31], pars->Unitary_GC_71, pars->Unitary_GC_74, pars->MC, pars->ZERO, w[61]); 
  FFV2_5_2(w[0], w[13], pars->Unitary_GC_71, pars->Unitary_GC_74, pars->MC, pars->ZERO, w[62]); 
  FFV1_1(w[1], w[28], pars->Unitary_GC_6, pars->MC, pars->ZERO, w[63]); 
  FFV1_1(w[1], w[8], pars->Unitary_GC_6, pars->MC, pars->ZERO, w[64]); 
  FFV2_5_1(w[1], w[31], pars->Unitary_GC_71, pars->Unitary_GC_74, pars->MC, pars->ZERO, w[65]); 
  FFV2_5_1(w[1], w[13], pars->Unitary_GC_71, pars->Unitary_GC_74, pars->MC, pars->ZERO, w[66]); 
  ...
  FFV1_0(w[52], w[1], w[28], pars->Unitary_GC_6, amp[88]); 
  FFV1_0(w[53], w[1], w[8], pars->Unitary_GC_6, amp[89]); 
  FFV2_5_0(w[52], w[1], w[31], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[90]); 
  FFV1_0(w[54], w[1], w[8], pars->Unitary_GC_6, amp[91]); 
  FFV1_0(w[55], w[1], w[28], pars->Unitary_GC_6, amp[92]); 
  FFV2_5_0(w[53], w[1], w[13], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[93]); 
  FFV2_5_0(w[55], w[1], w[31], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[94]); 
  FFV2_5_0(w[54], w[1], w[13], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[95]); 
  ...
  FFV1_0(w[59], w[56], w[28], pars->Unitary_GC_6, amp[112]); 
  FFV1_0(w[60], w[56], w[8], pars->Unitary_GC_6, amp[113]); 
  FFV2_5_0(w[59], w[56], w[31], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[114]); 
  FFV1_0(w[61], w[56], w[8], pars->Unitary_GC_6, amp[115]); 
  FFV1_0(w[62], w[56], w[28], pars->Unitary_GC_6, amp[116]); 
  FFV2_5_0(w[60], w[56], w[13], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[117]); 
  FFV2_5_0(w[62], w[56], w[31], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[118]); 
  FFV2_5_0(w[61], w[56], w[13], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[119]); 
  ...
  FFV1_0(w[59], w[63], w[6], pars->Unitary_GC_6, amp[128]); 
  FFV1_0(w[60], w[64], w[6], pars->Unitary_GC_6, amp[129]); 
  FFV1_0(w[59], w[65], w[6], pars->Unitary_GC_6, amp[130]); 
  FFV1_0(w[61], w[64], w[6], pars->Unitary_GC_6, amp[131]); 
  FFV1_0(w[62], w[63], w[6], pars->Unitary_GC_6, amp[132]); 
  FFV1_0(w[60], w[66], w[6], pars->Unitary_GC_6, amp[133]); 
  FFV1_0(w[62], w[65], w[6], pars->Unitary_GC_6, amp[134]); 
  FFV1_0(w[61], w[66], w[6], pars->Unitary_GC_6, amp[135]); 
  FFV1_0(w[59], w[1], w[45], pars->Unitary_GC_6, amp[136]); 
  FFV2_5_0(w[59], w[1], w[46], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[137]); 
  FFV1_0(w[0], w[64], w[45], pars->Unitary_GC_6, amp[138]); 
  FFV2_5_0(w[0], w[64], w[46], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[139]); 
  FFV1_0(w[62], w[1], w[45], pars->Unitary_GC_6, amp[140]); 
  FFV2_5_0(w[62], w[1], w[46], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[141]); 
  FFV1_0(w[0], w[66], w[45], pars->Unitary_GC_6, amp[142]); 
  FFV2_5_0(w[0], w[66], w[46], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[143]); 
  FFV1_0(w[59], w[1], w[47], pars->Unitary_GC_6, amp[144]); 
  FFV2_5_0(w[59], w[1], w[48], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[145]); 
  FFV1_0(w[0], w[64], w[47], pars->Unitary_GC_6, amp[146]); 
  FFV2_5_0(w[0], w[64], w[48], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[147]); 
  FFV1_0(w[62], w[1], w[47], pars->Unitary_GC_6, amp[148]); 
  FFV2_5_0(w[62], w[1], w[48], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[149]); 
  FFV1_0(w[0], w[66], w[47], pars->Unitary_GC_6, amp[150]); 
  FFV2_5_0(w[0], w[66], w[48], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[151]); 
  FFV1_0(w[60], w[1], w[26], pars->Unitary_GC_6, amp[152]); 
  FFV2_5_0(w[60], w[1], w[27], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[153]); 
  FFV1_0(w[0], w[63], w[26], pars->Unitary_GC_6, amp[154]); 
  FFV2_5_0(w[0], w[63], w[27], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[155]); 
  FFV1_0(w[61], w[1], w[26], pars->Unitary_GC_6, amp[156]); 
  FFV2_5_0(w[61], w[1], w[27], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[157]); 
  FFV1_0(w[0], w[65], w[26], pars->Unitary_GC_6, amp[158]); 
  FFV2_5_0(w[0], w[65], w[27], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[159]); 
  FFV1_0(w[60], w[1], w[35], pars->Unitary_GC_6, amp[160]); 
  FFV2_5_0(w[60], w[1], w[36], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[161]); 
  FFV1_0(w[0], w[63], w[35], pars->Unitary_GC_6, amp[162]); 
  FFV2_5_0(w[0], w[63], w[36], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[163]); 
  FFV1_0(w[61], w[1], w[35], pars->Unitary_GC_6, amp[164]); 
  FFV2_5_0(w[61], w[1], w[36], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[165]); 
  FFV1_0(w[0], w[65], w[35], pars->Unitary_GC_6, amp[166]); 
  FFV2_5_0(w[0], w[65], w[36], pars->Unitary_GC_71, pars->Unitary_GC_74, amp[167]); 

}
double BKG_UP_OFpA::matrix_ccx_emepmummupa_no_hzpxg() 
{
  int i, j; 
  // Local variables

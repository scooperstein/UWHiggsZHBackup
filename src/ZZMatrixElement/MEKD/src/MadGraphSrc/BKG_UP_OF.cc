...
void BKG_UP_OF::initProc(string param_card_name) 
{
...
void BKG_UP_OF::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
...
double BKG_UP_OF::matrix_ccx_emepmummup_no_hxg() 
{
  int i, j; 
  // Local variables

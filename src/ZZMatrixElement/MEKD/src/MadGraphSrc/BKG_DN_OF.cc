...
void BKG_DN_OF::initProc(string param_card_name) 
{
...
void BKG_DN_OF::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ssx_emepmummup_no_hxg(); 
        ...
        t[1] = matrix_ssx_emepmummup_no_hxg(); 
        double tsum = 0; 
...
void BKG_DN_OF::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//   int i, j; 
  ...
  FFV42_44_2(w[3], w[11], pars->GC_109, pars->GC_116, pars->Me, pars->ZERO,
      w[19]);
  FFV41_2(w[0], w[7], pars->GC_1, pars->MS, pars->ZERO, w[20]); 
  FFV41_2(w[0], w[14], pars->GC_1, pars->MS, pars->ZERO, w[21]); 
  FFV42_43_2(w[0], w[17], pars->GC_109, pars->GC_115, pars->MS, pars->ZERO,
      w[22]);
  ...
  FFV41_0(w[20], w[1], w[14], pars->GC_1, amp[16]); 
  FFV41_0(w[21], w[1], w[7], pars->GC_1, amp[17]); 
  FFV42_43_0(w[20], w[1], w[17], pars->GC_109, pars->GC_115, amp[18]); 
  FFV41_0(w[22], w[1], w[7], pars->GC_1, amp[19]); 
  FFV41_0(w[23], w[1], w[14], pars->GC_1, amp[20]); 
  FFV42_43_0(w[21], w[1], w[10], pars->GC_109, pars->GC_115, amp[21]); 
  FFV42_43_0(w[23], w[1], w[17], pars->GC_109, pars->GC_115, amp[22]); 
  FFV42_43_0(w[22], w[1], w[10], pars->GC_109, pars->GC_115, amp[23]); 

}
double BKG_DN_OF::matrix_ssx_emepmummup_no_hxg() 
{
  int i, j; 
  // Local variables

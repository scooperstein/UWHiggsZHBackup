...
// Process: s s~ > zp > e- e+ mu- mu+ a WEIGHTED=10

//--------------------------------------------------------------------------
// Initialize process.

void Spin1_DN_OFpA::initProc(string param_card_name) 
{
...
void Spin1_DN_OFpA::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
...
void Spin1_DN_OFpA::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//   int i, j; 
  ...
  FFV1_2_3_4_3(w[16], w[1], pars->HEF_MEKD_GC_131, pars->HEF_MEKD_GC_128, pars->HEF_MEKD_GC_129,
      pars->HEF_MEKD_GC_130, pars->MZp, pars->WZp, w[17]);
  FFV2_1(w[1], w[6], pars->HEF_MEKD_GC_3, pars->MS, pars->ZERO, w[18]); 
  FFV1_2_3_4_3(w[0], w[18], pars->HEF_MEKD_GC_131, pars->HEF_MEKD_GC_128, pars->HEF_MEKD_GC_129,
      pars->HEF_MEKD_GC_130, pars->MZp, pars->WZp, w[19]);
...
double Spin1_DN_OFpA::matrix_ssx_zp_emepmummupa() 
{
  int i, j; 
  // Local variables
//   const int ngraphs = 6; 

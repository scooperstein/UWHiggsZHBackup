...
#ifndef MG5_Sigma_HEF_MEKD_ssx_Xspin0_emepmummup_H
#define MG5_Sigma_HEF_MEKD_ssx_Xspin0_emepmummup_H
...
class Spin0_qq_DN_OF
{
  ...
  private:
    ...
    double matrix_ssx_h_emepmummup_no_zpxg(); 

...
#ifndef MG5_Sigma_HZZ_Unitary_ssx_emepmummupa_H
#define MG5_Sigma_HZZ_Unitary_ssx_emepmummupa_H
...
class BKG_DN_OFpA
{
  public:
    ...
    virtual string name() const {return "s s~ > e- e+ mu- mu+ a (HZZ_Unitary)";}
  ...
  private:
    ...
    double matrix_ssx_emepmummupa_no_hzpxg(); 
...
#endif  // MG5_Sigma_HZZ_Unitary_ssx_emepmummupa_H

...
#ifndef MG5_Sigma_HEF_MEKD_zp_mummupmummup_H
#define MG5_Sigma_HEF_MEKD_zp_mummupmummup_H
...
class Spin1_SF
{
  public:
    ...
    virtual string name() const {return "zp > mu- mu+ mu- mu+ (HEF_MEKD)";}
...
#endif  // MG5_Sigma_HEF_MEKD_zp_mummupmummup_H

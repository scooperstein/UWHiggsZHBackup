...
void Spin2_qq_UP_SF::initProc(string param_card_name) 
{
...
void Spin2_qq_UP_SF::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
...
double Spin2_qq_UP_SF::sigmaHat() 
{
...
void Spin2_qq_UP_SF::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double Spin2_qq_UP_SF::matrix_ccx_xg_mummupmummup() 
{
  int i, j; 
  // Local variables
//   const int ngraphs = 2; 

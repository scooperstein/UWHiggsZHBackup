...
#ifndef MG5_Sigma_HEF_MEKD_h_mummupmummupa_H
#define MG5_Sigma_HEF_MEKD_h_mummupmummupa_H
...
class Spin0_SFpA
{
  public:
    ...
    virtual string name() const {return "h > mu- mu+ mu- mu+ a (HEF_MEKD)";}
...
#endif  // MG5_Sigma_HEF_MEKD_h_mummupmummupa_H

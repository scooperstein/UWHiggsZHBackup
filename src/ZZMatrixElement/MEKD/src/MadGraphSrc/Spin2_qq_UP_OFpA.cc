...
// Process: c c~ > xg > e- e+ mu- mu+ a WEIGHTED=10

//--------------------------------------------------------------------------
// Initialize process.

void Spin2_qq_UP_OFpA::initProc(string param_card_name) 
{
...
void Spin2_qq_UP_OFpA::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
...
void Spin2_qq_UP_OFpA::sigmaKin() 
{
...
double Spin2_qq_UP_OFpA::sigmaHat() 
{
...
void Spin2_qq_UP_OFpA::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//   int i, j; 
  ...
  FFT1_2_3_4_3(w[16], w[1], pars->HEF_MEKD_GC_115, pars->HEF_MEKD_GC_112, pars->HEF_MEKD_GC_113,
      pars->HEF_MEKD_GC_114, pars->MXG, pars->WXG, w[17]);
  FFV2_1(w[1], w[6], pars->HEF_MEKD_GC_4, pars->MC, pars->ZERO, w[18]); 
  FFT1_2_3_4_3(w[0], w[18], pars->HEF_MEKD_GC_115, pars->HEF_MEKD_GC_112, pars->HEF_MEKD_GC_113,
      pars->HEF_MEKD_GC_114, pars->MXG, pars->WXG, w[19]);
...
double Spin2_qq_UP_OFpA::matrix_ccx_xg_emepmummupa() 
{
  int i, j; 
  // Local variables
//   const int ngraphs = 6; 

...
#ifndef MG5_Sigma_HEF_MEKD_ccx_Xspin2_mummupmummup_H
#define MG5_Sigma_HEF_MEKD_ccx_Xspin2_mummupmummup_H
...
class Spin2_qq_UP_SF
{
  ...
  private:
    ...
    double matrix_ccx_xg_mummupmummup(); 

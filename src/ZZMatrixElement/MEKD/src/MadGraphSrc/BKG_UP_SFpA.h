...
#ifndef MG5_Sigma_HZZ_Unitary_ccx_mummupmummupa_H
#define MG5_Sigma_HZZ_Unitary_ccx_mummupmummupa_H
...
class BKG_UP_SFpA
{
  public:
    ...
    virtual string name() const {return "c c~ > mu- mu+ mu- mu+ a (HZZ_Unitary)";}
  ...
  private:
    ...
    double matrix_ccx_mummupmummupa_no_hzpxg(); 

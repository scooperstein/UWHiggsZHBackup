...
#ifndef MG5_Sigma_HEF_MEKD_h_mummupmummup_H
#define MG5_Sigma_HEF_MEKD_h_mummupmummup_H
...
class Spin0_SF
{
  public:
    ...
    virtual string name() const {return "h > mu- mu+ mu- mu+ (HEF_MEKD)";}
...
#endif  // MG5_Sigma_HEF_MEKD_h_mummupmummup_H

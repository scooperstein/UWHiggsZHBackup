...
void BKG_DN_SF::initProc(string param_card_name) 
{
...
void BKG_DN_SF::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
...
void BKG_DN_SF::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double BKG_DN_SF::matrix_ssx_mummupmummup_no_hxg() 
{
  int i, j; 
  // Local variables

...
void Spin0_qq_UP_2l::initProc(string param_card_name) 
{
...
void Spin0_qq_UP_2l::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
...
double Spin0_qq_UP_2l::sigmaHat() 
{
...
void Spin0_qq_UP_2l::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double Spin0_qq_UP_2l::matrix_ccx_h_mummup_no_zpxg() 
{
  int i, j; 
  // Local variables
//   const int ngraphs = 1; 

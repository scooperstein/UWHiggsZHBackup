...
void BKG_UP_SFpA::initProc(string param_card_name) 
{
...
void BKG_UP_SFpA::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
...
void BKG_UP_SFpA::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double BKG_UP_SFpA::matrix_ccx_mummupmummupa_no_hzpxg() 
{
  int i, j; 
  // Local variables

...
namespace MG5_HEF_MEKD2_spin1_2lpA
{
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  P3[2] = -V3[1].imag(); 
  P3[3] = -V3[0].imag(); 
  TMP3 = (F1[2] * (F2[4] * - 1. * (P3[0] + P3[3]) - F2[5] * (P3[1] + cI *
    ...
    complex<double> COUP, complex<double> & vertex)
{
  complex<double> cI = complex<double> (0., 1.); 
  complex<double> TMP2; 
  TMP2 = (F1[2] * (F2[4] * - 1. * (V3[2] + V3[5]) - F2[5] * (V3[3] + cI *
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  P3[2] = -V3[1].imag(); 
  P3[3] = -V3[0].imag(); 
  TMP5 = (F1[4] * F2[4] + F1[5] * F2[5] - F1[2] * F2[2] - F1[3] * F2[3]); 
  TMP7 = (P1[0] * P3[0] - P1[1] * P3[1] - P1[2] * P3[2] - P1[3] * P3[3]); 
  TMP8 = (P2[0] * P3[0] - P2[1] * P3[1] - P2[2] * P3[2] - P2[3] * P3[3]); 
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  V3[2] = denom * TMP5 * (OM3 * P3[0] * (-cI * (TMP8) + cI * (TMP7)) + (-cI *
      (P1[0]) + cI * (P2[0])));
  V3[3] = denom * TMP5 * (OM3 * P3[1] * (-cI * (TMP8) + cI * (TMP7)) + (-cI *
      (P1[1]) + cI * (P2[1])));
  V3[4] = denom * TMP5 * (OM3 * P3[2] * (-cI * (TMP8) + cI * (TMP7)) + (-cI *
      (P1[2]) + cI * (P2[2])));
  V3[5] = denom * TMP5 * (OM3 * P3[3] * (-cI * (TMP8) + cI * (TMP7)) + (-cI *
      (P1[3]) + cI * (P2[3])));
}
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  vertex = COUP * TMP5 * (-cI * (TMP4) + cI * (TMP6)); 
}
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP4 = (V3[2] * P1[0] - V3[3] * P1[1] - V3[4] * P1[2] - V3[5] * P1[3]); 
  TMP6 = (V3[2] * P2[0] - V3[3] * P2[1] - V3[4] * P2[2] - V3[5] * P2[3]); 
  TMP9 = (F1[2] * F2[2] + F1[3] * F2[3] + F1[4] * F2[4] + F1[5] * F2[5]); 
  vertex = COUP * TMP9 * (-cI * (TMP4) + cI * (TMP6)); 
}
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  V3[2] = denom * TMP9 * (OM3 * P3[0] * (-cI * (TMP8) + cI * (TMP7)) + (-cI *
      (P1[0]) + cI * (P2[0])));
  V3[3] = denom * TMP9 * (OM3 * P3[1] * (-cI * (TMP8) + cI * (TMP7)) + (-cI *
      (P1[1]) + cI * (P2[1])));
  V3[4] = denom * TMP9 * (OM3 * P3[2] * (-cI * (TMP8) + cI * (TMP7)) + (-cI *
      (P1[2]) + cI * (P2[2])));
  V3[5] = denom * TMP9 * (OM3 * P3[3] * (-cI * (TMP8) + cI * (TMP7)) + (-cI *
      (P1[3]) + cI * (P2[3])));
}

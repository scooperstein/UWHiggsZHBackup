...
#ifndef Parameters_HEF_MEKD_H
#define Parameters_HEF_MEKD_H
...
class Parameters_HEF_MEKD
{
  public:

    static Parameters_HEF_MEKD * getInstance(); 
  ...
  private:
    static Parameters_HEF_MEKD * instance; 
}; 

#endif  // Parameters_HEF_MEKD_H

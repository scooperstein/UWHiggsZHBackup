...
void BKG_DN_OFpA::initProc(string param_card_name) 
{
...
void BKG_DN_OFpA::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
...
void BKG_DN_OFpA::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double BKG_DN_OFpA::matrix_ssx_emepmummupa_no_hzpxg() 
{
  int i, j; 
  // Local variables

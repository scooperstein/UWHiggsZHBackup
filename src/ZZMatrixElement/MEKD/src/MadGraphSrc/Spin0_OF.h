...
#ifndef MG5_Sigma_HEF_MEKD_h_emepmummup_H
#define MG5_Sigma_HEF_MEKD_h_emepmummup_H
...
class Spin0_OF
{
  public:
    ...
    virtual string name() const {return "h > e- e+ mu- mu+ (HEF_MEKD)";}
...
#endif  // MG5_Sigma_HEF_MEKD_h_emepmummup_H

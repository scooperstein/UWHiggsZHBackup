...
// Process: c c~ > xg > e- e+ mu- mu+ / g WEIGHTED=8

//--------------------------------------------------------------------------
// Initialize process.

void Spin2_qq_UP_OF::initProc(string param_card_name) 
{
...
void Spin2_qq_UP_OF::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ccx_xg_emepmummup_no_g(); 
        ...
        t[1] = matrix_ccx_xg_emepmummup_no_g(); 
        double tsum = 0; 
...
double Spin2_qq_UP_OF::sigmaHat() 
{
...
void Spin2_qq_UP_OF::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double Spin2_qq_UP_OF::matrix_ccx_xg_emepmummup_no_g() 
{
  int i, j; 
  // Local variables
//   const int ngraphs = 1; 

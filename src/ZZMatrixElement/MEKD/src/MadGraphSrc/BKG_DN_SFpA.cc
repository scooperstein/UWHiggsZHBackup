...
void BKG_DN_SFpA::initProc(string param_card_name) 
{
...
void BKG_DN_SFpA::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ssx_mummupmummupa_no_hzpxg(); 
        ...
        t[1] = matrix_ssx_mummupmummupa_no_hzpxg(); 
        double tsum = 0; 
...
void BKG_DN_SFpA::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//   int i, j; 
  ...
  FFV1_2(w[0], w[6], pars->Unitary_GC_5, pars->MS, pars->ZERO, w[69]); 
  FFV1_3(w[69], w[1], pars->Unitary_GC_5, pars->ZERO, pars->ZERO, w[70]); 
  FFV2_3_3(w[69], w[1], pars->Unitary_GC_70, pars->Unitary_GC_74, pars->MZ, pars->WZ, w[71]); 
  FFV1_2(w[69], w[8], pars->Unitary_GC_5, pars->MS, pars->ZERO, w[72]); 
  FFV1_2(w[69], w[45], pars->Unitary_GC_5, pars->MS, pars->ZERO, w[73]); 
  FFV2_3_2(w[69], w[46], pars->Unitary_GC_70, pars->Unitary_GC_74, pars->MS, pars->ZERO,
      w[74]);
  FFV2_3_2(w[69], w[13], pars->Unitary_GC_70, pars->Unitary_GC_74, pars->MS, pars->ZERO,
      w[75]);
  FFV1_2(w[69], w[25], pars->Unitary_GC_5, pars->MS, pars->ZERO, w[76]); 
  FFV1_2(w[69], w[41], pars->Unitary_GC_5, pars->MS, pars->ZERO, w[77]); 
  FFV2_3_2(w[69], w[43], pars->Unitary_GC_70, pars->Unitary_GC_74, pars->MS, pars->ZERO,
      w[78]);
  FFV2_3_2(w[69], w[29], pars->Unitary_GC_70, pars->Unitary_GC_74, pars->MS, pars->ZERO,
      w[79]);
  FFV1_1(w[1], w[6], pars->Unitary_GC_5, pars->MS, pars->ZERO, w[80]); 
  FFV1_3(w[0], w[80], pars->Unitary_GC_5, pars->ZERO, pars->ZERO, w[81]); 
  FFV2_3_3(w[0], w[80], pars->Unitary_GC_70, pars->Unitary_GC_74, pars->MZ, pars->WZ, w[82]); 
  FFV1_2(w[0], w[8], pars->Unitary_GC_5, pars->MS, pars->ZERO, w[83]); 
  FFV1_2(w[0], w[45], pars->Unitary_GC_5, pars->MS, pars->ZERO, w[84]); 
  FFV2_3_2(w[0], w[46], pars->Unitary_GC_70, pars->Unitary_GC_74, pars->MS, pars->ZERO, w[85]); 
  FFV2_3_2(w[0], w[13], pars->Unitary_GC_70, pars->Unitary_GC_74, pars->MS, pars->ZERO, w[86]); 
  FFV1_2(w[0], w[25], pars->Unitary_GC_5, pars->MS, pars->ZERO, w[87]); 
  FFV1_2(w[0], w[41], pars->Unitary_GC_5, pars->MS, pars->ZERO, w[88]); 
  FFV2_3_2(w[0], w[43], pars->Unitary_GC_70, pars->Unitary_GC_74, pars->MS, pars->ZERO, w[89]); 
  FFV2_3_2(w[0], w[29], pars->Unitary_GC_70, pars->Unitary_GC_74, pars->MS, pars->ZERO, w[90]); 
  FFV1_1(w[1], w[45], pars->Unitary_GC_5, pars->MS, pars->ZERO, w[91]); 
  FFV1_1(w[1], w[8], pars->Unitary_GC_5, pars->MS, pars->ZERO, w[92]); 
  FFV2_3_1(w[1], w[46], pars->Unitary_GC_70, pars->Unitary_GC_74, pars->MS, pars->ZERO, w[93]); 
  FFV2_3_1(w[1], w[13], pars->Unitary_GC_70, pars->Unitary_GC_74, pars->MS, pars->ZERO, w[94]); 
  FFV1_1(w[1], w[41], pars->Unitary_GC_5, pars->MS, pars->ZERO, w[95]); 
  FFV1_1(w[1], w[25], pars->Unitary_GC_5, pars->MS, pars->ZERO, w[96]); 
  FFV2_3_1(w[1], w[43], pars->Unitary_GC_70, pars->Unitary_GC_74, pars->MS, pars->ZERO, w[97]); 
  FFV2_3_1(w[1], w[29], pars->Unitary_GC_70, pars->Unitary_GC_74, pars->MS, pars->ZERO, w[98]); 
  ...
  FFV1_0(w[72], w[1], w[45], pars->Unitary_GC_5, amp[168]); 
  FFV1_0(w[73], w[1], w[8], pars->Unitary_GC_5, amp[169]); 
  FFV2_3_0(w[72], w[1], w[46], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[170]); 
  FFV1_0(w[74], w[1], w[8], pars->Unitary_GC_5, amp[171]); 
  FFV1_0(w[75], w[1], w[45], pars->Unitary_GC_5, amp[172]); 
  FFV2_3_0(w[73], w[1], w[13], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[173]); 
  FFV2_3_0(w[75], w[1], w[46], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[174]); 
  FFV2_3_0(w[74], w[1], w[13], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[175]); 
  ...
  FFV1_0(w[76], w[1], w[41], pars->Unitary_GC_5, amp[184]); 
  FFV1_0(w[77], w[1], w[25], pars->Unitary_GC_5, amp[185]); 
  FFV2_3_0(w[76], w[1], w[43], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[186]); 
  FFV1_0(w[78], w[1], w[25], pars->Unitary_GC_5, amp[187]); 
  FFV1_0(w[79], w[1], w[41], pars->Unitary_GC_5, amp[188]); 
  FFV2_3_0(w[77], w[1], w[29], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[189]); 
  FFV2_3_0(w[79], w[1], w[43], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[190]); 
  FFV2_3_0(w[78], w[1], w[29], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[191]); 
  ...
  FFV1_0(w[83], w[80], w[45], pars->Unitary_GC_5, amp[216]); 
  FFV1_0(w[84], w[80], w[8], pars->Unitary_GC_5, amp[217]); 
  FFV2_3_0(w[83], w[80], w[46], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[218]); 
  FFV1_0(w[85], w[80], w[8], pars->Unitary_GC_5, amp[219]); 
  FFV1_0(w[86], w[80], w[45], pars->Unitary_GC_5, amp[220]); 
  FFV2_3_0(w[84], w[80], w[13], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[221]); 
  FFV2_3_0(w[86], w[80], w[46], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[222]); 
  FFV2_3_0(w[85], w[80], w[13], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[223]); 
  ...
  FFV1_0(w[87], w[80], w[41], pars->Unitary_GC_5, amp[232]); 
  FFV1_0(w[88], w[80], w[25], pars->Unitary_GC_5, amp[233]); 
  FFV2_3_0(w[87], w[80], w[43], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[234]); 
  FFV1_0(w[89], w[80], w[25], pars->Unitary_GC_5, amp[235]); 
  FFV1_0(w[90], w[80], w[41], pars->Unitary_GC_5, amp[236]); 
  FFV2_3_0(w[88], w[80], w[29], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[237]); 
  FFV2_3_0(w[90], w[80], w[43], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[238]); 
  FFV2_3_0(w[89], w[80], w[29], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[239]); 
  ...
  FFV1_0(w[83], w[91], w[6], pars->Unitary_GC_5, amp[256]); 
  FFV1_0(w[84], w[92], w[6], pars->Unitary_GC_5, amp[257]); 
  FFV1_0(w[83], w[93], w[6], pars->Unitary_GC_5, amp[258]); 
  FFV1_0(w[85], w[92], w[6], pars->Unitary_GC_5, amp[259]); 
  FFV1_0(w[86], w[91], w[6], pars->Unitary_GC_5, amp[260]); 
  FFV1_0(w[84], w[94], w[6], pars->Unitary_GC_5, amp[261]); 
  FFV1_0(w[86], w[93], w[6], pars->Unitary_GC_5, amp[262]); 
  FFV1_0(w[85], w[94], w[6], pars->Unitary_GC_5, amp[263]); 
  FFV1_0(w[83], w[1], w[63], pars->Unitary_GC_5, amp[264]); 
  FFV2_3_0(w[83], w[1], w[64], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[265]); 
  FFV1_0(w[0], w[92], w[63], pars->Unitary_GC_5, amp[266]); 
  FFV2_3_0(w[0], w[92], w[64], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[267]); 
  FFV1_0(w[86], w[1], w[63], pars->Unitary_GC_5, amp[268]); 
  FFV2_3_0(w[86], w[1], w[64], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[269]); 
  FFV1_0(w[0], w[94], w[63], pars->Unitary_GC_5, amp[270]); 
  FFV2_3_0(w[0], w[94], w[64], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[271]); 
  FFV1_0(w[83], w[1], w[65], pars->Unitary_GC_5, amp[272]); 
  FFV2_3_0(w[83], w[1], w[66], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[273]); 
  FFV1_0(w[0], w[92], w[65], pars->Unitary_GC_5, amp[274]); 
  FFV2_3_0(w[0], w[92], w[66], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[275]); 
  FFV1_0(w[86], w[1], w[65], pars->Unitary_GC_5, amp[276]); 
  FFV2_3_0(w[86], w[1], w[66], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[277]); 
  FFV1_0(w[0], w[94], w[65], pars->Unitary_GC_5, amp[278]); 
  FFV2_3_0(w[0], w[94], w[66], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[279]); 
  FFV1_0(w[87], w[95], w[6], pars->Unitary_GC_5, amp[280]); 
  FFV1_0(w[88], w[96], w[6], pars->Unitary_GC_5, amp[281]); 
  FFV1_0(w[87], w[97], w[6], pars->Unitary_GC_5, amp[282]); 
  FFV1_0(w[89], w[96], w[6], pars->Unitary_GC_5, amp[283]); 
  FFV1_0(w[90], w[95], w[6], pars->Unitary_GC_5, amp[284]); 
  FFV1_0(w[88], w[98], w[6], pars->Unitary_GC_5, amp[285]); 
  FFV1_0(w[90], w[97], w[6], pars->Unitary_GC_5, amp[286]); 
  FFV1_0(w[89], w[98], w[6], pars->Unitary_GC_5, amp[287]); 
  FFV1_0(w[87], w[1], w[53], pars->Unitary_GC_5, amp[288]); 
  FFV2_3_0(w[87], w[1], w[54], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[289]); 
  FFV1_0(w[0], w[96], w[53], pars->Unitary_GC_5, amp[290]); 
  FFV2_3_0(w[0], w[96], w[54], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[291]); 
  FFV1_0(w[90], w[1], w[53], pars->Unitary_GC_5, amp[292]); 
  FFV2_3_0(w[90], w[1], w[54], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[293]); 
  FFV1_0(w[0], w[98], w[53], pars->Unitary_GC_5, amp[294]); 
  FFV2_3_0(w[0], w[98], w[54], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[295]); 
  FFV1_0(w[87], w[1], w[61], pars->Unitary_GC_5, amp[296]); 
  FFV2_3_0(w[87], w[1], w[62], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[297]); 
  FFV1_0(w[0], w[96], w[61], pars->Unitary_GC_5, amp[298]); 
  FFV2_3_0(w[0], w[96], w[62], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[299]); 
  FFV1_0(w[90], w[1], w[61], pars->Unitary_GC_5, amp[300]); 
  FFV2_3_0(w[90], w[1], w[62], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[301]); 
  FFV1_0(w[0], w[98], w[61], pars->Unitary_GC_5, amp[302]); 
  FFV2_3_0(w[0], w[98], w[62], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[303]); 
  FFV1_0(w[88], w[1], w[37], pars->Unitary_GC_5, amp[304]); 
  FFV2_3_0(w[88], w[1], w[38], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[305]); 
  FFV1_0(w[0], w[95], w[37], pars->Unitary_GC_5, amp[306]); 
  FFV2_3_0(w[0], w[95], w[38], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[307]); 
  FFV1_0(w[89], w[1], w[37], pars->Unitary_GC_5, amp[308]); 
  FFV2_3_0(w[89], w[1], w[38], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[309]); 
  FFV1_0(w[0], w[97], w[37], pars->Unitary_GC_5, amp[310]); 
  FFV2_3_0(w[0], w[97], w[38], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[311]); 
  FFV1_0(w[84], w[1], w[39], pars->Unitary_GC_5, amp[312]); 
  FFV2_3_0(w[84], w[1], w[40], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[313]); 
  FFV1_0(w[0], w[91], w[39], pars->Unitary_GC_5, amp[314]); 
  FFV2_3_0(w[0], w[91], w[40], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[315]); 
  FFV1_0(w[85], w[1], w[39], pars->Unitary_GC_5, amp[316]); 
  FFV2_3_0(w[85], w[1], w[40], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[317]); 
  FFV1_0(w[0], w[93], w[39], pars->Unitary_GC_5, amp[318]); 
  FFV2_3_0(w[0], w[93], w[40], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[319]); 
  FFV1_0(w[88], w[1], w[67], pars->Unitary_GC_5, amp[320]); 
  FFV2_3_0(w[88], w[1], w[68], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[321]); 
  FFV1_0(w[0], w[95], w[67], pars->Unitary_GC_5, amp[322]); 
  FFV2_3_0(w[0], w[95], w[68], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[323]); 
  FFV1_0(w[89], w[1], w[67], pars->Unitary_GC_5, amp[324]); 
  FFV2_3_0(w[89], w[1], w[68], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[325]); 
  FFV1_0(w[0], w[97], w[67], pars->Unitary_GC_5, amp[326]); 
  FFV2_3_0(w[0], w[97], w[68], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[327]); 
  FFV1_0(w[84], w[1], w[55], pars->Unitary_GC_5, amp[328]); 
  FFV2_3_0(w[84], w[1], w[56], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[329]); 
  FFV1_0(w[0], w[91], w[55], pars->Unitary_GC_5, amp[330]); 
  FFV2_3_0(w[0], w[91], w[56], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[331]); 
  FFV1_0(w[85], w[1], w[55], pars->Unitary_GC_5, amp[332]); 
  FFV2_3_0(w[85], w[1], w[56], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[333]); 
  FFV1_0(w[0], w[93], w[55], pars->Unitary_GC_5, amp[334]); 
  FFV2_3_0(w[0], w[93], w[56], pars->Unitary_GC_70, pars->Unitary_GC_74, amp[335]); 

}
double BKG_DN_SFpA::matrix_ssx_mummupmummupa_no_hzpxg() 
{
  int i, j; 
  // Local variables

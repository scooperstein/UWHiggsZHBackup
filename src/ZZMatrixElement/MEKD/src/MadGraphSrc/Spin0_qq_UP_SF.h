...
#ifndef MG5_Sigma_HEF_MEKD_ccx_Xspin0_mummupmummup_H
#define MG5_Sigma_HEF_MEKD_ccx_Xspin0_mummupmummup_H
...
class Spin0_qq_UP_SF
{
  ...
  private:
    ...
    double matrix_ccx_h_mummupmummup_no_zpxg(); 

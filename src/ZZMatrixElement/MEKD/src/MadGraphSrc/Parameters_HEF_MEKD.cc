...
#ifndef Parameters_HEF_MEKD_CC
#define Parameters_HEF_MEKD_CC
...
Parameters_HEF_MEKD * Parameters_HEF_MEKD::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_HEF_MEKD * Parameters_HEF_MEKD::getInstance()
{
  if (instance == 0)
    instance = new Parameters_HEF_MEKD(); 

  return instance; 
}

void Parameters_HEF_MEKD::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_HEF_MEKD::setIndependentCouplings()
{
	GC_1 = -(ee * complexi)/3.;
...
void Parameters_HEF_MEKD::setDependentCouplings()
{

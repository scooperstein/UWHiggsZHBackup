...
void BKG_UP_SF::initProc(string param_card_name) 
{
...
void BKG_UP_SF::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ccx_mummupmummup_no_hxg(); 
        ...
        t[1] = matrix_ccx_mummupmummup_no_hxg(); 
        double tsum = 0; 
...
void BKG_UP_SF::calculate_wavefunctions(const int perm[], const int hel[])
{
...
//   int i, j; 
  ...
  FFV42_44_3(w[5], w[4], pars->GC_109, pars->GC_116, pars->MZ, pars->WZ,
      w[23]);
  FFV41_2(w[0], w[7], pars->GC_2, pars->MC, pars->ZERO, w[24]); 
  FFV41_2(w[0], w[22], pars->GC_2, pars->MC, pars->ZERO, w[25]); 
  FFV42_45_2(w[0], w[23], pars->GC_110, pars->GC_115, pars->MC, pars->ZERO,
      w[26]);
  FFV42_45_2(w[0], w[10], pars->GC_110, pars->GC_115, pars->MC, pars->ZERO,
      w[27]);
  FFV41_2(w[0], w[14], pars->GC_2, pars->MC, pars->ZERO, w[28]); 
  FFV41_2(w[0], w[18], pars->GC_2, pars->MC, pars->ZERO, w[29]); 
  FFV42_45_2(w[0], w[20], pars->GC_110, pars->GC_115, pars->MC, pars->ZERO,
      w[30]);
  FFV42_45_2(w[0], w[16], pars->GC_110, pars->GC_115, pars->MC, pars->ZERO,
      w[31]);
  ...
  FFV41_0(w[24], w[1], w[22], pars->GC_2, amp[32]); 
  FFV41_0(w[25], w[1], w[7], pars->GC_2, amp[33]); 
  FFV42_45_0(w[24], w[1], w[23], pars->GC_110, pars->GC_115, amp[34]); 
  FFV41_0(w[26], w[1], w[7], pars->GC_2, amp[35]); 
  FFV41_0(w[27], w[1], w[22], pars->GC_2, amp[36]); 
  FFV42_45_0(w[25], w[1], w[10], pars->GC_110, pars->GC_115, amp[37]); 
  FFV42_45_0(w[27], w[1], w[23], pars->GC_110, pars->GC_115, amp[38]); 
  FFV42_45_0(w[26], w[1], w[10], pars->GC_110, pars->GC_115, amp[39]); 
  FFV41_0(w[28], w[1], w[18], pars->GC_2, amp[40]); 
  FFV41_0(w[29], w[1], w[14], pars->GC_2, amp[41]); 
  FFV42_45_0(w[28], w[1], w[20], pars->GC_110, pars->GC_115, amp[42]); 
  FFV41_0(w[30], w[1], w[14], pars->GC_2, amp[43]); 
  FFV41_0(w[31], w[1], w[18], pars->GC_2, amp[44]); 
  FFV42_45_0(w[29], w[1], w[16], pars->GC_110, pars->GC_115, amp[45]); 
  FFV42_45_0(w[31], w[1], w[20], pars->GC_110, pars->GC_115, amp[46]); 
  FFV42_45_0(w[30], w[1], w[16], pars->GC_110, pars->GC_115, amp[47]); 

}
double BKG_UP_SF::matrix_ccx_mummupmummup_no_hxg() 
{
  int i, j; 
  // Local variables

...
void Spin1_UP_OFpA::initProc(string param_card_name) 
{
...
void Spin1_UP_OFpA::updateProc(SLHAReader slha) 
{
  pars->setIndependentParameters(slha); 
  pars->setIndependentCouplings(); 
...
void Spin1_UP_OFpA::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double Spin1_UP_OFpA::matrix_ccx_zp_emepmummupa() 
{
  int i, j; 
  // Local variables
//   const int ngraphs = 6; 

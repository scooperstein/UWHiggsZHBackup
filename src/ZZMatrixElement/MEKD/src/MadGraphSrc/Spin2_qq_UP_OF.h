...
#ifndef MG5_Sigma_HEF_MEKD_ccx_Xspin2_emepmummup_H
#define MG5_Sigma_HEF_MEKD_ccx_Xspin2_emepmummup_H
...
class Spin2_qq_UP_OF
{
  ...
  private:
    ...
    double matrix_ccx_xg_emepmummup_no_g(); 

...
#ifndef MG5_Sigma_HEF_MEKD_xg_emepmummup_H
#define MG5_Sigma_HEF_MEKD_xg_emepmummup_H
...
class Spin2_OF
{
  public:
    ...
    virtual string name() const {return "xg > e- e+ mu- mu+ (HEF_MEKD)";}
...
#endif  // MG5_Sigma_HEF_MEKD_xg_emepmummup_H

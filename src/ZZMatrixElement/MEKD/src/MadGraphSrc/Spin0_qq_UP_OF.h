...
#ifndef MG5_Sigma_HEF_MEKD_ccx_Xspin0_emepmummup_H
#define MG5_Sigma_HEF_MEKD_ccx_Xspin0_emepmummup_H
...
class Spin0_qq_UP_OF
{
  ...
  private:
    ...
    double matrix_ccx_h_emepmummup_no_zpxg(); 

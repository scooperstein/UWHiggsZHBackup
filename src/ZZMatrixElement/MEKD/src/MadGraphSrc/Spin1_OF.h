...
#ifndef MG5_Sigma_HEF_MEKD_zp_emepmummup_H
#define MG5_Sigma_HEF_MEKD_zp_emepmummup_H
...
class Spin1_OF
{
  public:
    ...
    virtual string name() const {return "zp > e- e+ mu- mu+ (HEF_MEKD)";}
...
#endif  // MG5_Sigma_HEF_MEKD_zp_emepmummup_H

    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  P2[2] = V2[1].imag(); 
  P2[3] = V2[0].imag(); 
  TMP13 = -1. * (P2[0] * (V1[3] * (V3[5] * V2[4] - V3[4] * V2[5]) + (V1[4] *
      ...
      V2[2]))))));
  TMP12 = -1. * (P1[0] * (V1[3] * (V3[5] * V2[4] - V3[4] * V2[5]) + (V1[4] *
      (V3[3] * V2[5] - V3[5] * V2[3]) + V1[5] * (V3[4] * V2[3] - V3[3] *
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  V3[2] = denom * TMP19 * (OM3 * P3[0] * (-cI * (TMP2) + cI * (TMP1)) + (-cI *
      (P1[0]) + cI * (P2[0])));
  V3[3] = denom * TMP19 * (OM3 * P3[1] * (-cI * (TMP2) + cI * (TMP1)) + (-cI *
      (P1[1]) + cI * (P2[1])));
  V3[4] = denom * TMP19 * (OM3 * P3[2] * (-cI * (TMP2) + cI * (TMP1)) + (-cI *
      (P1[2]) + cI * (P2[2])));
  V3[5] = denom * TMP19 * (OM3 * P3[3] * (-cI * (TMP2) + cI * (TMP1)) + (-cI *
      (P1[3]) + cI * (P2[3])));
}
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  vertex = COUP * - 1. * (+cI * (TMP15) + 2. * cI * (TMP16)); 
}
